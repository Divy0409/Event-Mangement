			...
			<div class="col-md-6 col-lg-3">
				<div class="full socile_icons fb margin_bottom_30">
					...
					<div class="social_cont">
						<ul>
							<li><span><strong>35k</strong></span> <span>Friends</span></li>
							<li><span><strong>128</strong></span> <span>Feeds</span></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="full socile_icons tw margin_bottom_30">
					...
					<div class="social_cont">
						<ul>
							...
							<li><span><strong>978</strong></span> <span>Tweets</span></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="full socile_icons linked margin_bottom_30">
					...
					<div class="social_cont">
						<ul>
							...
							<li><span><strong>365</strong></span> <span>Feeds</span></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="full socile_icons google_p margin_bottom_30">
					...
					<div class="social_cont">
						<ul>
							...
							<li><span><strong>57</strong></span> <span>Circles</span></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="dash_blog">
					<div class="dash_blog_inner">
						...
						<div class="msg_list_main">
							<ul class="msg_list">
								<li><span><img src="images/layout_img/msg2.png"
										class="img-responsive" alt="#" /></span> <span> <span
										class="name_user">Herman Beck</span> <span class="msg_user">Sed
											ut perspiciatis unde omnis.</span> <span class="time_ago">12
											min ago</span>
								</span></li>
								<li><span><img src="images/layout_img/msg3.png"
										class="img-responsive" alt="#" /></span> <span> <span

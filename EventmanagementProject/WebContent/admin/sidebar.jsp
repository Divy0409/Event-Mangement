			...
			<ul class="list-unstyled components">
				...
				<li><a href="#element" data-toggle="collapse"
					aria-expanded="false" class="dropdown-toggle"><i
						class="fa fa-diamond purple_color"></i> <span>Packages</span></a>
					<ul class="collapse list-unstyled" id="element">
						<li><a href="addpackages.jsp">> <span>Add Main
									Packages</span></a></li>
						<li><a href="subpackages.jsp">> <span>Add Sub
									packages</span></a></li>
						<li><a href="ViewMainPackage.jsp">> <span>View
									Main Packages</span></a></li>
						<li><a href="invoice.html">> <span>View Sub
									Packages</span></a></li>
					</ul></li>
				...
				<li class="active"><a href="#additional_page"
					data-toggle="collapse" aria-expanded="false"
					class="dropdown-toggle"><i class="fa fa-clone yellow_color"></i>

				...
				<div class="row">
					<div class="col-lg-12">
						<div class="product__details__breadcrumb">
							<span style="color:red;">Corporate Event Details</span>
						</div>
					</div>
				</div>
				<div class="row">
							...
							<li class="nav-item"><a class="nav-link active"
								data-toggle="tab" href="#tabs-1" role="tab">
									<div class="product__thumb__pic set-bg"
										data-setbg="corporate/corporate1.jpeg"></div>
							</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#tabs-2" role="tab">
									<div class="product__thumb__pic set-bg"
										data-setbg="corporate/corporate2.jpeg"></div>
							</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="tab"
								href="#tabs-3" role="tab">
									<div class="product__thumb__pic set-bg"
										data-setbg="corporate/corporate3.jpeg"></div>
							</a></li>							
						</ul>
					</div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tabs-1" role="tabpanel">
								<div class="product__details__pic__item">
									<img src="corporate/corporate1.jpeg" alt="">
								</div>
							</div>
							<div class="tab-pane" id="tabs-2" role="tabpanel">
								<div class="product__details__pic__item">
									<img src="corporate/corporate2.jpeg" alt="">
								</div>
							</div>
							<div class="tab-pane" id="tabs-3" role="tabpanel">
								<div class="product__details__pic__item">
									<img src="corporate/corporate3.jpeg" alt="">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tabs-5" role="tabpanel">
									<div class="product__details__tab__content">
										<p class="note">You can organize this type of event for corporate 
										meetings like Annual Budget Meeting, Company Anniversary Meeting etc.</p>
										<div class="product__details__tab__content__item">
											<h5>Event Information</h5>
											<p>This event contains several aspects to be fulfilled as it is
											   corporate meeting. And every thing that will be organized has to
